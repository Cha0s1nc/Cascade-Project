  ...
  return (
    <View style={styles.trackRow}>
      ...
      <View style={styles.trackText}>
        ...
        <Bone width="32%" height={10} style={{ marginTop: spacing.sm }} />
      </View>
...
export function CardSkeleton() {
  return (
    <View style={[styles.card, { width: ART_SIZE }]}>
      ...
      <Bone width="80%" height={13} style={{ marginTop: spacing.sm }} />
      <Bone width="50%" height={10} style={{ marginTop: spacing.xs }} />
    </View>
  );
}
