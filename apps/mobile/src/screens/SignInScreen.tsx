...
function SignInScreen({
  ...
  // Return-key chaining. On a phone the keyboard covers half the screen, so
  // reaching down to tap the next field means dismissing and reopening it three
  // times to fill in one form. The return key should just move on, and on the
  // last field submit.
